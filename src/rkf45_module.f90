...
contains
    ...
    subroutine rkf45(f, neqn, y, t, tout, relerr, abserr, iflag, work, iwork)
        ...
        real(rk), intent(inout) :: relerr, work(*)
    ...
    subroutine rkfs(f, neqn, y, t, tout, relerr, abserr, iflag, &
        ...
        real(rk) :: abserr, h, yp(neqn), f1(neqn), f2(neqn), f3(neqn), f4(neqn), f5(neqn), savre, savae
...
300     t = tout
    ...
    subroutine fehl(f, neqn, y, t, h, yp, f1, f2, f3, f4, f5, s)
        ...
        procedure(fcn) :: f
        integer, intent(in) :: neqn
        real(rk) y(neqn), t, h, yp(neqn), f1(neqn), f2(neqn), f3(neqn), f4(neqn), f5(neqn), s(neqn)
